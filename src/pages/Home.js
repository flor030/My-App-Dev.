          ...
          <div className="col-12">
            ...
            <img src='images/service.png' alt='services' />
              ...
              <div className='d-flex align-items-center gap-15'>
                ...
                <div>
                  <h6>Ofertas diarias de sorpresas</h6>
              ...
              <div className='d-flex align-items-center gap-15'>
                ...
                <div>
                  ...
                  <p className='mb-0'>Obtener precios predeterminados de fábrica</p>
                </div>
              </div>
              <div className='d-flex align-items-center gap-15'>
                ...
                <div>
                  <h6>Pagos Seguros</h6>
                  <p className='mb-0'>Pago 100% Protegido</p>
                </div>
            </div>
            </div>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-3">
            <div className="famous-card position-relative">
              ...
              <div className="famous-content position-absolute">
                ...
                <p className="text-dark">Pantalla 5K de 27 pulgadas</p>
              </div>
            </div>
          </div>
          <div className="col-3">
            <div className="famous-card position-relative">
              ...
              />
              <div className="famous-content position-absolute">
                <h5 className="text-dark">Celulares</h5>
                <h6 className="text-dark">Smartphone 13 Pro.</h6>
                <p className="text-dark">
                Ahora en Verde. Desde $999.00
                </p>
              </div>
            </div>
          </div>
          <div className="col-3">
            <div className="famous-card position-relative">
              ...
              />
              <div className="famous-content position-absolute">
                <h5 className="text-dark">Altavoces</h5>
